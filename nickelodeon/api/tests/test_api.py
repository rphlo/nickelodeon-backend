...
class ApiTestCase(APITestCase):
    ...
    def test_api(self):
        ...
        self.assertTrue(res.get('X-Accel-Redirect').startswith(f'/s3_proxy/{settings.S3_BUCKET}/{self.user.settings.storage_prefix}/foo.mp3'))
        ...
        self.assertEquals(res.status_code, status.HTTP_206_PARTIAL_CONTENT)
        self.assertTrue(res.get('X-Accel-Redirect').startswith(f'/s3_proxy/{settings.S3_BUCKET}/{self.user.settings.storage_prefix}/bar.mp3'))
